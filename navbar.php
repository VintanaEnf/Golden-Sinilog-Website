<nav class = "flexnav">
    ...
    margin: auto;margin-left: 15px;" href="aboutus.php">About Us</a>
            ...
            <div style="justify-content: end; align-items: center; margin-right: 30px;">
                <button onclick="window.location.href = 'http://localhost/Golden-Sinilog/SignIn.php'" class = "navbutton nav_loginbutton" type="submit" href="#">Login</button>
                <button onclick="window.location.href = 'http://localhost/Golden-Sinilog/Signup.php'" class = "navbutton nav_loginbutton" type="submit" href="#">Sign Up</button>
